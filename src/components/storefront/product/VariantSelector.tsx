                  ...
                  <button
                    ...
                    style={
                      option.secondaryColorHex 
                        ? { background: `linear-gradient(135deg, ${option.colorHex || option.value.toLowerCase()} 50%, ${option.secondaryColorHex} 50%)` }
                        : { backgroundColor: option.colorHex || option.value.toLowerCase() }
                    }
                    title={
